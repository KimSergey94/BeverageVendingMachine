...
namespace BeverageVendingMachine.Infrastructure.Migrations
{
    ...
    partial class BeverageVendingMachineContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeverageVendingMachine.Core.Entities.Aggregates.StorageAggregate.CoinDenomination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BeverageVendingMachine.Core.Entities.Aggregates.StorageAggregate.StorageItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BeverageVendingMachine.Core.Entities.CoinOperation", b =>
                {
                    b.HasOne("BeverageVendingMachine.Core.Entities.Aggregates.StorageAggregate.CoinDenomination", "CoinDenomination")
                        .WithMany()
